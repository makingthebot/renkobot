...
from telegram.ext import (Application, CommandHandler,
                          MessageHandler, ApplicationBuilder, CallbackContext, Updater)
from telegram.ext.filters import TEXT

from telegram.ext import CommandHandler, ContextTypes, MessageHandler, CallbackContext
import telegram
import os
import sys
...
async def startup():
    log_message(f"[ Hello World! ] ver :{VERSION}")
    send_telegram_message(f" [ Hello World! ] ver :{VERSION}")
